...
from core.fd_encoder import twins_svt_large, twins_svt_small_context, BasicEncoder, FeatureFusionTransformer
from core.fd_decoder import UpSampleMask8, UpSampleMask4, TransformerModule, SKUpdate, SinusoidalPositionEmbeddings, SKUpdateDFM
from core.fd_corr import CorrBlock_FD_Sp4
...
class DiffABFlow(nn.Module):
    def __init__(self, args):
        ...
        self.enet = BasicEncoder(input_dim=self.event_bins, output_dim=c_dim, norm_fn='instance', dropout=self.dropout)
        ...
        self.fusion_net = FeatureFusionTransformer(in_dim=c_dim, depth=3, num_heads=8)
    ...
    def forward(self, image1, image2, event_voxel, test_mode=False, iters=None, flow_gt=None, flow_init=None):
